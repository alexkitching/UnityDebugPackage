...
namespace TMPro
{
    ...
    /// </summary>
    [AddComponentMenu("UI/KConsole/KConsole TMP Input Field", 11)]
    public class TMP_InputField_ConsoleEdit : Selectable,
        ...
        IScrollHandler
    {
        ...
        protected TMP_InputField_ConsoleEdit()
        {
        ...
        protected EditState KeyPressed(Event evt)
        {
            ...
            switch (evt.keyCode)
            {
                ...
                case KeyCode.UpArrow:
                    {
                        //MoveUp(shift); // Removed for custom prediction item highlighting
                        return EditState.Continue;
                    }

                case KeyCode.DownArrow:
                    {
                        //MoveDown(shift); // Removed for custom prediction item highlighting
                        return EditState.Continue;
                    }
